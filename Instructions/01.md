...
1. Now, enter the **Password**- <inject key="AzureAdUserPassword"></inject> which you have already received for the above account.
...
1. On the Azure Monitor **Insights Onboarding** page, choose the existing **Log Analytics Workspace**  LogAnalyticsWS-<

 key="DeploymentID/Suffix" /> and then click on **Enable** button.
